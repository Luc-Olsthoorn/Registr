...
export class filterHandler {
  ...
  addHtml() {
    ...
    let underTheFold = $(`<div class="ui grid content"></div>`);
    let days = $(`<div class="eight wide column"></div>`);
    let times = $(`<div class="eight wide column"></div>`);
    this.filterArray = [
...
class filterBox {
  ...
  addHtml() {
    ...
    this.checkbox = $(
      `<div class="ui checked toggle checkbox" style="padding: 5px;"></div>`
    );
    this.actualBox = $(`
